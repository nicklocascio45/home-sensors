...
{
	/**
	 * Initialized data is put in flash because we want to preserve
	 * initial values on controller reset, but we then move it to
	 * sram so that we can read/write it faster during program execution
	 */
